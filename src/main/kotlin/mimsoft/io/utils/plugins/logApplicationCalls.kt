  ...
  intercept(ApplicationCallPipeline.Monitoring) {
    ...
    DBManager.insert(
      ...
      mapOf(
        ...
        2 to requestUri,
        3 to requestHeaders,
        4 to requestParameters,
        5 to responseStatus,
        6 to responseHeaders,
        7 to responseTime
      )
    )

    // логирование тела ответа может быть невозможно без поддержки двойного чтения тела или без
    // нарушения чтения тела
