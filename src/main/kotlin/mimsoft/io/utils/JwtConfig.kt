...
object JwtConfig {
  ...
  fun generateRegToken(deviceId: Long?, phone: String?): String =
    JWT.create()
      .withSubject("reg")
      .withIssuer(issuer)
      .withClaim("deviceId", deviceId)
  ...
  fun generateMerchantToken(merchantId: Long?, uuid: String?): String =
    JWT.create()
  ...
  fun generateUserToken(merchantId: Long?, uuid: String?): String =
    JWT.create()
      .withSubject("user")
      .withIssuer(issuer)
      .withClaim("merchantId", merchantId)
  ...
  fun generateStaffToken(merchantId: Long?, staffId: Long?, uuid: String?): String =
    JWT.create()
      .withSubject("staff")
      .withIssuer(issuer)
      .withClaim("merchantId", merchantId)
  ...
  fun generateCourierToken(merchantId: Long?, staffId: Long?, uuid: String?): String =
    JWT.create()
      .withSubject("courier")
      .withIssuer(issuer)
      .withClaim("merchantId", merchantId)
  ...
  fun generateStaffToken(merchantId: Long?, uuid: String?): String =
    JWT.create()
      .withSubject("stuff")
      .withIssuer(issuer)
      .withClaim("merchantId", merchantId)
  ...
  fun generateAdminToken(phone: String, uuid: String?): String =
    JWT.create()
      .withSubject("admin")
      .withIssuer(issuer)
      .withClaim("phone", phone)
  ...
  fun generateManagerToken(phone: String, uuid: String?, id: Long?): String =
    JWT.create()
      .withSubject("manager")
      .withIssuer(issuer)
      .withClaim("phone", phone)
  ...
  fun generateModifyToken(sessionUuid: String?): String? =
    JWT.create()
      .withSubject("modify")
      .withIssuer(issuer)
  ...
  fun generateOperatorToken(merchantId: Long?, uuid: String?, staffId: Long?): String? =
    JWT.create()
