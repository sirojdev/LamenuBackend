...
object CourierSocketService {
     val courierConnections: MutableSet<CourierConnection> = Collections.synchronizedSet(LinkedHashSet())

    fun setConnection(courier: CourierConnection): CourierConnection {
        val connection = courierConnections.find { it.staffId == courier.staffId && it.merchantId == courier.merchantId && it.uuid == courier.uuid}
