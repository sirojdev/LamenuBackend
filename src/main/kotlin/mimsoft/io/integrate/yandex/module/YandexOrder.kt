...
data class YandexOrder(
    ...
    var callbackProperties: CallbackProperties?=null,
    @SerializedName("client_requirements")
    var clientRequirements: Requirement?=null,
    ...
    var offerPayload: String?=null,
    @SerializedName("optional_return")
    var optionalReturn: Boolean?=null,
    @SerializedName("order_url")
    var referralSource: String?=null,
    @SerializedName("route_points")
    var routePoints: List<YandexOrderRoutePoint>?=null,
    @SerializedName("same_day_data")
    var sameDayData: SameDayData?=null,
    @SerializedName("shipping_document")
    var shippingDocument: String?=null,
    @SerializedName("skip_act")
    var skipAct: Boolean?=null,
    @SerializedName("skip_client_notify")
    var skipClientNotify: Boolean?=null,
    @SerializedName("skip_door_to_door")
    var skipDoorToDoor: Boolean?=null,
    @SerializedName("skip_emergency_notify")
    var skipEmergencyNotify: Boolean?=null,
...
data class EmergencyContact(
    ...
    var phoneAdditionalCode: String?=null
)
...
data class Fiscalization(
    ...
    var supplierInn: String? = null,
    @SerializedName("vat_code_str")
    var vatCodeStr: String? = null
)
...
data class SameDayData(
    @SerializedName("delivery_intervar ")
    var deliveryIntervar: DeliveryIntervar? = null
)

data class DeliveryIntervar(
