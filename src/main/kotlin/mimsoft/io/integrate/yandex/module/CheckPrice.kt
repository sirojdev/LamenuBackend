...
data class YandexCheckPrice(
  ...
  @SerializedName("route_points") var routePoints: List<RoutePoints>? = null,
  val requirements: CheckPriceRequirements? = null,
  val skipDoorToDoor: Boolean = false
)

data class Items(var quantity: Int? = null, var size: Size? = null, var weight: Double? = null)

data class RoutePoints(var coordinates: ArrayList<Double>? = null, var fullname: String? = null)
