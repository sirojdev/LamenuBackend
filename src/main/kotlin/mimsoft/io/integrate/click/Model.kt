...
data class ClickErrors(val error: Int? = null, val error_note: String? = null) {
  companion object {
...
data class ClickRespondPrepare(
  @SerializedName("merchant_prepare_id") val merchantPrepareId: Long? = null,
...
data class ClickRespondComplete(
  @SerializedName("merchant_confirm_id") val merchantConfirmId: Long? = null,
  val clickTransId: Long? = null,
  val merchantTransId: String? = null,
  val error: Int? = null,
  val errorNote: String? = null
