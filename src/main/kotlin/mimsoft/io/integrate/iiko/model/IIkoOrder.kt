...
data class PaymentAdditionalData(@SerializedName("type") var type: String? = null)
...
data class Card(@SerializedName("track") var track: String? = null)

data class Discounts(@SerializedName("type") var type: String? = null)
...
data class LoyaltyInfo(
  ...
  @SerializedName("applicableManualConditions")
  var applicableManualConditions: ArrayList<String>? = null
)
