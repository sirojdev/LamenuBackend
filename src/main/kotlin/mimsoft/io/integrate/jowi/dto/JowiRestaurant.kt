...
data class JowiRestaurant(
  ...
  @SerializedName("restaurant_type") val type: String? = null,
  @SerializedName("work_time") val workTime: String? = null,
  @SerializedName("phone_numbers") val phone: String? = null,
