...
fun Route.routeToJowi() {
  route("jowi") {
    ...
    /**
     * bitta developer boladi va bu developerdagi barcha restaurantlarni olib kelib beradi va client
     * ozini restaurantini tanlab oladi har safar restaurantlar olib kelinadi va branchga boglanadi
     * * *
     */
    get("restaurant") {
    ...
    /**
     * shu restaurantni mahsulotlarini olib keladi id ni product table ga qoshadi qolgan malumotlari
     * jowi_productsga qoshiladi
     */
    get("courses") {
