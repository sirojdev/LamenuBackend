...
import mimsoft.io.integrate.uzum.module.UZUM_PAYMENT_TABLE
import mimsoft.io.integrate.uzum.module.UzumOperationType
...
object MerchantIntegrateRepository {
    ...
    suspend fun save(
        integrate: MerchantIntegrateDto
    ) {
        val query =
    ...
    suspend fun get(
        ...
        val query =
            "select * from $MERCHANT_INTEGRATE_TABLE where merchant_id = $merchantId"
