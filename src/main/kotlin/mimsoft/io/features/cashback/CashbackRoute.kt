...
fun Route.routeToCashback() {
  ...
  route("cashback") {
    ...
    post {
      ...
      val response =
        cashbackService.add(cashbackDto.copy(merchantId = merchantId, branchId = branchId))
    ...
    put {
      ...
      val updated =
        cashbackService.update((cashback.copy(merchantId = merchantId, branchId = branchId)))
...
data class CashbackId(val id: Long? = null)
