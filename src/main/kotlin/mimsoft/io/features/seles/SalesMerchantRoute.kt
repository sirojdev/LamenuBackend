...
import mimsoft.io.entities.seles.repository.SalesMerchantRepositoryImpl

fun Route.routeToMerchant() {

  val merchantRepository: SalesMerchantInterface = SalesMerchantRepositoryImpl

  route("merchant") {
    get {
      //            val restaurants = merchantRepository.getAll().map
      // {AdminMerchantMapper.toAdminMerchantDto(it)}
