...
object ProductLabelService {
    ...
    suspend fun deleteProductLabel(productLabelDto: ProductLabelDto): Boolean {
        val query = "update $PRODUCT_LABEL_TABLE set deleted = true where merchant_id = ${productLabelDto.merchantId} and product_id = ${productLabelDto.productId} and label_id = ${productLabelDto.labelId}"
