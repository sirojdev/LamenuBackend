...
object ProductOptionService {
  ...
  suspend fun deleteProductOption(productOptionDto: ProductOptionDto): Boolean {
    val query =
      "update $PRODUCT_OPTION_TABLE set deleted = true where merchant_id = ${productOptionDto.merchantId} and product_id = ${productOptionDto.productId} and option_id = ${productOptionDto.optionId}"
