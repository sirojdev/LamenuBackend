...
object ProductExtraService {
  ...
  suspend fun deleteProductExtra(productExtraDto: ProductExtraDto): Boolean {
    val query =
      "update $PRODUCT_EXTRA_TABLE set deleted = true where merchant_id = ${productExtraDto.merchantId} and product_id = ${productExtraDto.productId} and extra_id = ${productExtraDto.extraId}"
