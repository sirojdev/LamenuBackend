...
object ManagerService {
    ...
    suspend fun add(managerTable: ManagerTable?): Long? =
        repository.postData(dataClass = ManagerTable::class, dataObject = managerTable, tableName = "manager")

    suspend fun update(managerTable: ManagerTable?): Boolean =
        repository.updateData(dataClass = ManagerTable::class, dataObject = managerTable, tableName = "manager")
