...
class RoomServiceTest {
  ...
  fun add() = testApplication {
    val roomTable = RoomTable(name = "Romm-77", branchId = 33, merchantId = 1)
  ...
  fun update() = testApplication {
    val tableDto = listOf(TableDto(id = 11))
    val roomDto =
      RoomDto(id = 3444, name = "Room-777", branchId = 34, merchantId = 1, tables = tableDto)
