...
class BookRepositoryImplTest {
  ...
  fun update() = testApplication {
    ...
    val clientId = UserDto(id = 9)
    val tableId = TableDto(id = 21)
    val bookDto = BookDto(merchantId = 6, id = 34, client = clientId, table = tableId, time = null)
  ...
  fun updateMerchantBook() = testApplication {
    val tableId = TableDto(id = 21)
    val bookDto =
      BookDto(id = 37, merchantId = 6, table = tableId, time = null, comment = "This is comment")
