...
class ProductRepositoryImplTest {
  ...
  fun update() = testApplication {
    ...
    val categoryDto = CategoryDto(id = 14)
    val productIntegrationDto = ProductIntegrationDto(id = 17)
    val optionDto = listOf(OptionDto(id = 17))
    val extraDto = listOf(ExtraDto(id = 11))
    val labelDto = listOf(LabelDto(id = 12))
    val productDto =
      ProductDto(
        id = 12211,
        merchantId = 1,
